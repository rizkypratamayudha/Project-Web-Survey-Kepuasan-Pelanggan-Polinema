...
include("model/biodata_alumni_model.php");
                ...
                <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%">Tanggal Respon</th>
                            <th style="width: 20%">Jawaban</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php 
                        $data = $alumni->getDataUser();
                        $i = 1;
                        while($row = $data->fetch_assoc()){
                            ...
                            <td>
                            <a title="#" href="jawaban_alumni.php?responden_alumni_id='.$row['responden_alumni_id'].'" class="btn btn-sm btn-primary"><i class="bi bi-eye-fill"></i> Lihat</a>
                            </td>
                            </tr>';
                            $i++;
                        }
