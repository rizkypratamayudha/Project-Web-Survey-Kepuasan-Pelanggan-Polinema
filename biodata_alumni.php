    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                ?>
                <div class="card-body">
                    <form action="biodata_alumni_action.php?act=tambah" method="post" class="form-grid" id="biodata">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control">Survey Alumni</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="responden_prodi" class="form-control">
                        </div>
                        <div class="form-group">
