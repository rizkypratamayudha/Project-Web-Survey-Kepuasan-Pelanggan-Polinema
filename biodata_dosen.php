    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                ?>
                <div class="card-body">
                    <form action="biodata_dosen_action.php?act=tambah" id="biodata" method="POST" class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control">Survey Dosen</p>
                            <input type="hidden" name="survey_id" value="1">
                        </div>
                        <div class="form-group">
                            <label for="nip">NIP</label>
                            <input type="text" name="responden_nip" class="form-control"required></input>
                        </div>
                        <div class="form-group">
                            <label for="unit">Unit</label>
                            <input type="text" name="responden_unit" class="form-control"required></input>
                        </div>
                        <div class="form-group">
