    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                ?>
                <div class="card-body">
                    <form action="biodata_tendik_action.php?act=tambah" method="post" class="form-grid" id="biodata">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control">Survey Tendik</p>
                            <input type="hidden" name="survey_id" value="3">
                        </div>
                        <div class="form-group">
                            <label for="nopeg">NOPEG</label>
                            <input type="text" name="responden_nopeg" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="unit">Unit</label>
                            <input type="text" name="responden_unit" class="form-control">
                        </div>
                        <div class="form-group">
