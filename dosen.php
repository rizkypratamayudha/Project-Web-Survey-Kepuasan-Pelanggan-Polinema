<?php 
$menu = 'dosen';
include("model/biodata_dosen_model.php");
$dosen = new Dosen();
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 18%;">Tanggal Respon</th>
                                <th style="width: 12%;">Jawaban</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 
                            $data = $dosen->getDataUser();
                            $i = 1;
                            while($row = $data->fetch_assoc()){
                                ...
                                <td>
                                <a title="#" href="jawaban_dosen.php?responden_dosen_id='.$row['responden_dosen_id'].'" class="btn btn-sm btn-primary"><i class="bi bi-eye-fill"></i> Lihat</a>
                                </td>
                                </tr>';
                                $i++;
                            }
