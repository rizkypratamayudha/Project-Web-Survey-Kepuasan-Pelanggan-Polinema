  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card card-primary">
        ...
        <form method="post" action="form_soal_dosen_action.php?act=simpan&responden_dosen_id=<?php echo $_GET['responden_dosen_id']; ?>" onsubmit="return validateForm()">
          <div class="card-body">
            <?php
            $soal = $soalDosen->getSoalDosen();
            if ($soal) {
          ...
          <div class="card-body">
            <?php 
              $esai = $soalDosen->getSoalDosenEsai();
              if ($esai) {
          ...
          <div class="btn-container">
            <a href="biodata_dosen.php" class="btn btn-warning btn-left">Kembali</a>
