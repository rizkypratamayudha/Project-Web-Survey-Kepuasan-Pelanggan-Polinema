        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Form Survey Industri</h3>
                </div>
                <form method="post" action="form_soal_industri_action.php?act=simpan&responden_industri_id=<?php echo $_GET['responden_industri_id']; ?>" onsubmit="return validateForm()">
                    <div class="card-body">
                        <?php
                        $soal = $soalIndustri->getSoalIndustri();
                        if ($soal) {
                    ...
                    <div class="card-body">
                        <?php
                          $esai = $soalIndustri->getSoalIndustriEsai();
                          if ($esai) {
                    ...
                    <div class="btn-container">
                        <a href="biodata_industri.php" class="btn btn-warning btn-left">Kembali</a>
...
function showNextSurveyModal() {
    $('#nextSurveyModal').modal('show');
}
</script>
<!-- jQuery -->
