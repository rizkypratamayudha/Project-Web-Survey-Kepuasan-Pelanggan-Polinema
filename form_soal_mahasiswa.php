        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Form Survey Dosen</h3>
                </div>
                    <form method="post" action="form_soal_mhs_action.php?act=simpan&responden_mahasiswa_id=<?php echo $_GET['responden_mahasiswa_id']; ?>" onsubmit="return validateForm()">
                        <div class="card-body">
                        <?php
                        $soal = $soalMahasiswa->getSoalMhs();
                        if ($soal) {
                    ...
                    <a href="biodata_mahasiswa.php" class="btn btn-warning btn-left">Kembali</a>
