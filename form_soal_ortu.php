    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <h3 class="card-title">Form Survey Orang Tua</h3>
                </div>
                <form method="post" action="form_soal_ortu_action.php?act=simpan&responden_ortu_id=<?php echo $_GET['responden_ortu_id']; ?>" onsubmit="return validateForm()">
                    <div class="card-body">
                        <?php
                        $soal = $soalOrtu->getSoalOrtu();
                        if ($soal) {
                    ...
                    <div class="btn-container">
                        <a href="biodata_orangtua.php" class="btn btn-warning btn-left">Kembali</a>
