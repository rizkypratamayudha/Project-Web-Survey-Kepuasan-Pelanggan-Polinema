        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Form Survey Tendik</h3>
                </div>
                <form method="post" action="form_soal_tendik_action.php?act=simpan&responden_tendik_id=<?php echo $_GET['responden_tendik_id']; ?>" onsubmit="return validateForm()">
                    <div class="card-body">
                        <?php
                        $soal = $soalTendik->getSoalTendik();
                        if ($soal) {
                    ...
                    <div class="card-body">
                        <?php
                        $esai = $soalTendik->getSoalTendikEsai();
                        if ($esai) {
                    ...
                    <div class="btn-container">
                        <a href="biodata_tendik.php" class="btn btn-warning btn-left">Kembali</a>
