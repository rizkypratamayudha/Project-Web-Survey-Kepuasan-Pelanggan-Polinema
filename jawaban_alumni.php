<?php 
include("model/formjawaban/jawab_alumni_model.php");
$alumni = new JawabAlumni();
$responden_alumni_id = $_GET['responden_alumni_id'];
$jawaban = $alumni->getDataById($responden_alumni_id);
$menu = 'alumni';    
?>
...
<script>
  document.getElementById('eksporBtn').addEventListener('click', function() {
    ...
    XLSX.writeFile(workbook, 'Jawaban_Alumni.xlsx');
  });
</script>
</body>
</html>