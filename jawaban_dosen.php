<?php 
include("model/formjawaban/jawab_dosen_model.php");
$dosen = new JawabDosen();
$responden_dosen_id = $_GET['responden_dosen_id'];
$jawaban = $dosen->getDataById($responden_dosen_id);
$menu = 'dosen';    
?>
...
<script>
  document.getElementById('eksporBtn').addEventListener('click', function() {
    ...
    XLSX.writeFile(workbook, 'Jawaban_Dosen.xlsx');
  });
</script>
</body>
</html>