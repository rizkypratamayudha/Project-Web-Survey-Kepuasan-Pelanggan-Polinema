<?php 
include("model/formjawaban/jawab_industri_model.php");
$industri = new JawabIndustri();
$responden_industri_id = $_GET['responden_industri_id'];
$jawaban = $industri->getDataById($responden_industri_id);
$menu = 'industri';    
?>
...
<script>
  document.getElementById('eksporBtn').addEventListener('click', function() {
    ...
    XLSX.writeFile(workbook, 'Jawaban_Industri.xlsx');
  });
</script>
</body>
</html>