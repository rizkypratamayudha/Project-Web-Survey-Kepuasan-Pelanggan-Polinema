<?php 
include("model/formjawaban/jawab_mhs_model.php");
$mahasiswa= new JawabMahasiswa();
$responden_mahasiswa_id = $_GET['responden_mahasiswa_id'];
$jawaban = $mahasiswa->getDataById($responden_mahasiswa_id);
$menu = 'mahasiswa';    
?>
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <?php
                            while ($row = $jawaban->fetch_assoc()) {
                                echo '
                                <tr>
                                <td>'.$row['jawaban_mahasiswa_id'].'</td>
                                <td>'.$row['soal_nama'].'</td>
                                <td>'.$row['jawaban'].'</td>
                                </tr>';
                            }
...
<script>
  document.getElementById('eksporBtn').addEventListener('click', function() {
    ...
    XLSX.writeFile(workbook, 'Jawaban_Mahasiswa.xlsx');
  });
</script>
</body>
</html>