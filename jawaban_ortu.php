<?php 
include("model/formjawaban/jawab_ortu_model.php");
$orangtua = new JawabOrtu();
$responden_ortu_id = $_GET['responden_ortu_id'];
$jawaban = $orangtua->getDataById($responden_ortu_id);
$menu = 'orangtua';    
?>
...
<script>
  document.getElementById('eksporBtn').addEventListener('click', function() {
    ...
    XLSX.writeFile(workbook, 'Jawaban_Orang Tua.xlsx');
  });
</script>
</body>
</html>