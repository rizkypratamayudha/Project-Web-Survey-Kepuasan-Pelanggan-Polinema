...
include("model/biodata_mhs_model.php");
$mhs = new BiodataMhs();
                ...
                <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 13%">Tanggal Respon</th>
                            <th style="width: 8%">Jawaban</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php 
                            $data = $mhs->getDataUser();
                            $i = 1;
                            while($row = $data->fetch_assoc()){
                                ...
                                <td>
                                <a title="#" href="jawaban_mhs.php?responden_mahasiswa_id='.$row['responden_mahasiswa_id'].'" class="btn btn-sm btn-primary"><i class="bi bi-eye-fill"></i> Lihat</a>
                                </td>
                                </tr>';
                                $i++;
                            }
