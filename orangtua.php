...
include("model/biodata_ortu_model.php");
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <?php     
                            ...
                            while($row = $data->fetch_assoc()){
                                ...
                                <td>
                                <a title="#" href="jawaban_ortu.php?responden_ortu_id='.$row['responden_ortu_id'].'" class="btn btn-sm btn-primary"><i class="bi bi-eye-fill"></i> Lihat</a>
                                </td>
                                </tr>';
                                $i++;
                            }
