<?php 
$menu = 'tendik';
include("model/biodata_tendik_model.php");
            ...
            <div class="card-body">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%">Respon Tanggal</th>
                        <th style="width: 20%">Jawaban</th>        
                    </tr>
                </thead>
                <tbody>
                <?php 
                    $data = $tendik->getDataUser();
                    $i = 1;
                    while($row = $data->fetch_assoc()){
                        ...
                        <td>
                        <a title="#" href="jawaban_tendik.php?responden_tendik_id='.$row['responden_tendik_id'].'" class="btn btn-sm btn-primary"><i class="bi bi-eye-fill"></i> Lihat</a>
                        </td>
                        </tr>';
                        $i++;
                    }
